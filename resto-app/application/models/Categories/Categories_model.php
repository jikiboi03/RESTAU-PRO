...
class Categories_model extends CI_Model {
    ...
    var $column_order = array('cat_id','name','descr','encoded',null); //set column field database for datatable orderable
    var $column_search = array('cat_id','name','descr','encoded'); //set column field database for datatable searchable

    var $order = array('cat_id' => 'desc'); // default order 
