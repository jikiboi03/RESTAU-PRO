                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Categories Information Table</h3>
                        </div>
                        <div class="panel-body">
                            <button class="btn btn-success" onclick="add_category()"><i class="fa fa-plus-square"></i> &nbsp;Add New Category</button>
                            <button class="btn btn-default" onclick="reload_table()"><i class="fa fa-refresh"></i> &nbsp;Reload</button>
                            <br><br>
                            <table id="categories-table" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 14px;">
                                <thead>
                                    <tr>
