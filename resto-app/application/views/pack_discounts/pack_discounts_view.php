            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Package Discounts List</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                <!--Page content-->
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Package Discounts Information Table</h3>
                        </div>
                        <div class="panel-body">
                            <button class="btn btn-success" onclick="add_pack_discount()"><i class="fa fa-plus-square"></i> &nbsp;Add New Package Discount</button>
                            <button class="btn btn-default" onclick="reload_table()"><i class="fa fa-refresh"></i> &nbsp;Reload</button>
                            <br><br>
                            <table id="pack-discounts-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title">Package Discount Form</h3>
                        </div>
                            ...
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select id="discount_pack_id" name="pack_id" class="form-control">
                                                <option value="">--Select Package--</option>
                                                <?php 
                                                    foreach($packages as $row)
                                                    { 
                                                      echo '<option value="'.$row->pack_id.'">'.$row->name.'</option>';
                                                    }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="orig_price" name="orig_price" placeholder="Package Original Price" class="form-control" type="number" readonly>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="new_price" name="new_price" placeholder="Package Discounted Price" class="form-control" type="number">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
